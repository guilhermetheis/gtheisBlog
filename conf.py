...
# Guilherme's Blog build configuration file, created by
# `ablog start` on Sun Feb 24 15:32:24 2019.
#
...
blog_title = u'Guilherme\'s Blog Blog'
...
blog_authors = {
    'Guilherme Theis': ('Guilherme Theis', None),
}
...
htmlhelp_basename = 'GuilhermesBlogdoc'
